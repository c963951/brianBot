...
import com.example.bot.spring.service.CalendarService;
...
public class EchoApplication {
  ...
  public static List<Message> getCalendar() throws Exception {
    List<Message> result = CalendarService.getInstance().getCalendar();
    return result;
  }
  ...
  private void push(
      @NonNull String channelToken, @NonNull String pushId, @NonNull List<Message> messages)
      throws Exception {
    try {
